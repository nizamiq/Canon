...
# Canon: Technical Debt & Gap Register

This register tracks all known technical debt and gaps for the `Canon` project. It is seeded from the February 2026 ecosystem audit.
...
| AUDIT-005 | HIGH | Minimal CI — lacks security scanning and deployment stages | To be determined | OPEN |
